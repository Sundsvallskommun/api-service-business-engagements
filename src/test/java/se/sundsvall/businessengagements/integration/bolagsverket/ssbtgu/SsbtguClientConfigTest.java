...
class SsbtguClientConfigTest {
	...
	@InjectMocks
	private SsbtguClientConfig ssbtguClientConfig;

	@Test
	void testGetSsbtguWebserviceTemplate() {

		when(ssbtProperties.ssbtguApiUrl()).thenReturn("http://example.com");
